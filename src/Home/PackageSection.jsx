    ...
    return (
        <div className="mt-20">
            ...
            <div className="flex flex-wrap gap-12 justify-center items-center">
                <div className="w-full sm:w-auto border-2 border-slate-400 px-4 py-4 rounded-lg bg-indigo-300">
                    <div className="card w-full sm:w-80 md:w-[340px] bg-indigo-700 text-white shadow-xl hover:-translate-y-12 transition duration-700">
