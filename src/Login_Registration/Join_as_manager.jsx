                    ...
                    <div className="flex flex-col-reverse md:flex-row justify-center items-center md:p-20 max-w-screen-xl ">
                        <div className="px-16 md:px-10 py-10 bg-gray-200 rounded-xl w-[350px] md:w-[770px] border-2 border-slate-600">
                            ...
                            <form onSubmit={handleRegistration} className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-5">
                                ...
                                <button type="Submit" className="btn bg-blue-600 text-white hover:text-black hover:bg-white hover:border-2 hover:border-black w-[220px] lg:w-[620px]" >Sign up</button>
                                <br />
                                <div className="-mt-5 md:mt-5">
                                    <button onClick={handleGoogleSignup} className="btn  text-white hover:text-black w-[220px] hover:bg-white hover:border-2 hover:border-black lg:w-[620px] bg-red-500">Sign up with your gmail <FaGoogle /></button>
                                </div>
                            </form>
                        </div>
