...
const ThankYouComponent = () => {
    return (
        <div className="flex flex-col-reverse md:flex-row justify-center items-center bg-blue-700 rounded-lg">
            <div className="container mt-2 text-white">
                <div className="px-20 rounded-lg shadow-md ">
                    <h2 className=" text-3xl lg:text-5xl font-semibold mb-4">Thank You!</h2>
                    ...
                    <p className="text-white text-[17px] pb-5 md:pb-0">
                        ...
                        <Link to="https://aesthetic-mousse-9f2882.netlify.app/">
                            <button className="bg-purple-300 text-black border-2 border-slate-200 py-1 px-4 mt-3 md:mt-0  rounded-lg hover:bg-purple-800 hover:text-white hover:border-2 hover:border-slate-300">
                                Go
                            </button>
                        </Link>
                    </p>
